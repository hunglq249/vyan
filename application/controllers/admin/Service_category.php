...
class Service_category extends Admin_Controller{
	...
	public function index(){
        ...
        $total_rows  = $this->service_category_model->count_search($keywords);
        ...
        $result = $this->service_category_model->get_all_with_pagination_search('desc', $per_page, $this->data['page'], $keywords);
