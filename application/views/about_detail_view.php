<div class="post-detail">
    <div class="container cover">
        <div class="mask">
            <img src="<?php echo base_url('assets/upload/about/' . $detail['slug'] . '/' . $detail['image']); ?>" alt="Cover of Post Detail">
        </div>
    </div>
    ...
    <div class="container post-content">
        <div class="post-content-header">
            ...
            <div class="post-feature" style="display: none;">
                <div class="row">
                                ...
                                <?php foreach ($related as $key => $value): ?>
                                    <div class="post-item">
                                        ...
                                        <h5 class="text-wrapper">
                                            <a href="<?php echo base_url('ve-chung-toi/' . $category['slug'] . '/' . $value['slug']) ?>">
