<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url('admin/service_category') ?>"><i class="fa fa-dashboard"></i> Danh sách danh mục cho academy</a></li>
            <li class="active">Thêm mới danh mục cho academy</li>
        </ol>
    </section>
