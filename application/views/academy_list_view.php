<div class="post-list">
    <div class="container cover">
        <div class="mask">
            <img src="<?php echo base_url('assets/upload/academy_category/' . $detail['slug'] . '/' . $detail['image']) ?>" alt="<?php echo $detail['title'] ?>">
        </div>
    </div>
                ...
                <?php if ( $result ): ?>
                    <?php foreach ($result as $key => $value): ?>
                        <div class="item col-xs-12 col-md-6 col-lg-4">
                            <a href="<?php echo base_url('hoc-vien-vyan/' . $detail['slug'] . '/' . $value['slug']) ?>">
                                <div class="inner">
                                    <div class="mask">
