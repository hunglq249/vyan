...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Thêm mới library</li>
        </ol>
    </section>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-xs-12">
                            <div class="form-group col-xs-12">
                                ...
                                <?php if ( $detail['image'] ): ?>
                                    <img src="<?php echo base_url('assets/upload/library/' . $detail['slug'] . '/' . $detail['image']) ?>" width="150">
                                <?php else: ?>
                        ...
                        <div class="form-group col-md-12">
                            <?php
                            echo form_label('Kiểu thư viện', 'type');
                            echo form_error('type', '<div class="error">', '</div>');
                            echo form_dropdown('type', array(1 =>'Hình ảnh', 2 => 'Video'), $detail['type'], 'class="form-control" id="type"');
                            ?>
                        </div>
                        ...
                        <div class="form-group col-xs-12" style="padding-right: 0px;">
                            <div class="form-group col-xs-12" style="padding-right: 0px;">
                                <?php
                                echo form_label('Tiêu đề library', 'title');
