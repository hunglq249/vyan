                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-xs-12">
                            <div class="form-group col-xs-12">
                                ...
                                <?php if ( $detail['image'] ): ?>
                                    <img src="<?php echo base_url('assets/upload/why/' . $detail['slug'] . '/' . $detail['image']) ?>" width="150">
                                <?php else: ?>
                                ...
                                <select name="icon" class="form-control select2">
                                    <?php if ($icons): ?>
                                        <?php foreach ($icons as $key => $value): ?>
                                            <option value="<?php echo $value['c'] ?>" <?php echo $value['c'] == $detail['icon'] ? 'selected' : '' ?> data-icon="<?php echo $value['c'] ?>"><?php echo $value['l'] ?></option>
                                        <?php endforeach ?>
                                    <?php endif ?>
                                </select>
                            </div>
