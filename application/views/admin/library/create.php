...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url('admin/service') ?>"><i class="fa fa-dashboard"></i> Danh sách library</a></li>
                ...
                <div class="box box-default">
                    <div class="box-body">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            echo form_dropdown('type', array('1' =>'Hình ảnh', '2' => 'Video'), 1, 'class="form-control" id="type"');
                            ?>
                        </div>
