                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-xs-12">
                            <div class="form-group col-xs-12">
                                ...
                                <?php if ( $detail['image'] ): ?>
                                    <img src="<?php echo base_url('assets/upload/doctor/' . $detail['image']) ?>" width="150">
                                <?php else: ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            echo form_textarea('biography', $detail['biography'], 'class="form-control" id="biography"');
                            ?>
                        </div>
                        <div class="form-group col-xs-12">
