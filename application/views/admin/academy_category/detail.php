        ...
        <div class="row">
                            ...
                            <div class="detail-image col-md-6">
                                ...
                                <div class="row">
                                    <div class="item col-md-12">
                                        <div class="mask-lg">
                                            <?php if ( $detail['image'] ): ?>
                                                <img src="<?= base_url('assets/upload/academy_category/' . $detail['slug'] . '/' . $detail['image'] ) ?>" alt="Image Detail" width=100%>    
                                            <?php endif ?>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-md-3">
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <a href="<?= base_url('admin/academy_category/edit/' . $detail['id']) ?>" class="btn btn-warning" role="button">Chỉnh sửa</a>
                    </div>
                </div>
            </div>
        </div>
