...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url('admin/customer') ?>"><i class="fa fa-dashboard"></i> Danh sách khách hàng</a></li>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-xs-12">
                            <div class="form-group col-xs-12">
                                ...
                                <?php if ( $detail['image'] ): ?>
                                    <img src="<?php echo base_url('assets/upload/customer/' . $detail['image']) ?>" width="150">
                                <?php else: ?>
