...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url('admin/service') ?>"><i class="fa fa-dashboard"></i> Danh sách danh mục dịch vụ</a></li>
        </ol>
    </section>
                                            ...
                                            <tr class="remove-<?= $value['id'] ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= base_url('admin/service/edit/' . $value['id'] ) ?>" style="color: #f0ad4e" title="Cập nhật">
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="javascript:void(0)" class="btn-active" title="Duyệt bài" data-id="<?= $value['id'] ?>" data-url="<?= base_url('admin/service/active' ) ?>" style="color: #00a65a" >
                                                            <i class="fa fa-check" aria-hidden="true"></i>
                                                        </a>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="javascript:void(0)" class="btn-deactive" title="Tắt danh mục" data-id="<?= $value['id'] ?>" data-url="<?= base_url('admin/service/deactive' ) ?>" style="color: #f0ad4e">
