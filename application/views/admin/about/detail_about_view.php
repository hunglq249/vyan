<link rel="stylesheet" href="<?php echo site_url('assets/scss/admin/') ?>detail.css">
                            ...
                            <div class="detail-image col-md-6">
                                ...
                                <div class="row">
                                    <div class="item col-md-12">
                                        <div class="mask-lg">
                                            <img src="<?php echo base_url('assets/upload/about/'. $detail['image'] ) ?>" alt="Image Detail" width=300px>
                                        </div>
                                    </div>
                                </div>
                            </div>
